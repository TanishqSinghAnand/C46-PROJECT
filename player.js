class Form{
	...
	hidef(){
		...
		if(gamestate === 2){
			...
			this.Q2O3.position(77,2635);

			//QUESTION 3
			text("Q3 What percentage of people confirmed to have Covid-19 develop mild or moderate symptoms?",77,275);
			this.Q3O1.position(77,2695);
			this.Q3O2.position(77,2718);
			this.Q3O3.position(77,2742);

			//QUESTION 4
			fill("yellow");
	//		console.log("tanishq");
			text("Q4 What is a safe distance to stay apart from someone who is sick",77,380);
			this.Q4O1.position(77,2800);
			this.Q4O2.position(77,2830);
			this.Q4O3.position(77,2860);
		...
		if( gamestate === 3){
			...
			textSize(15);
			fill("green");
			text("iii) 'Several hours to days",77,120);
			...
			textSize(20);
			fill("yellow");
			text("Q4 What is a safe distance to stay apart from someone who is sick",77,370);
			textSize(15);
			fill("red");
			text("i) 1 foot",77,385);
			text("iii) 7.5 feet",77,425)
			textSize(15);
			fill("green");
			text("ii) 3 feet",77,405);
			...
			text("Reason - Soap breaks the structure of virus and makes it inactive",77,255);
			text("Reason - A joint investigation by the WHO and China found that 80% of laboratory-confirmed patients have mild to moderate disease, which  include a mild  pneumonia",77,350);
			text("Reason - COVID-19 virus spread via respiratory droplets expelled by an infected person's cough or sneeze. So WHO advices staying 1 meter(3 feet) away from a sick person",77,440);
